...
public class ProductInformationTest {
    ...
    public void productInformation(){
        ...
        //VERIFY thta same name and price displayed as on the homepage
    ...
    public void productInfoDetails(){
        //VERIFY that default quantity ia 1
    ...
    public void productInfoAddToCart(){
        ...
        //VERIFY confirmation message "Prduct successfully added to your shopping cart"
       ...
       // String actualMessage = confirmationMessage.getAttribute("textContent").trim();
